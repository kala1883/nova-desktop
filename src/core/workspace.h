...
typedef struct { wchar_t name[64], target[NOVA_PATH_CAP]; long long id; } AppItem;
typedef struct { wchar_t name[40]; int app_count; AppItem apps[MAX_APPS]; long long id; int items_loaded; } Workspace;
