...
typedef struct {HWND list,spaces;int source,source_row,hover_workspace,armed,dragging,enabled,left_down;POINT down;DropCallback drop;void *context;} HoldDrag;
